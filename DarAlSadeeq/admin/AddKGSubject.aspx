<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddKGSubject.aspx.vb" Inherits="admin_AddKGSubject" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
                ...
                <li id="submenu-active"><a href="AddKGSubject.aspx"> إضافة موضوع </a></li>
                <li><a href="DeleteSubject.aspx"> حذف موضوع </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
