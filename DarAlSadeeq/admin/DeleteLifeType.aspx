<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteLifeType.aspx.vb" Inherits="admin_DeleteLifeType" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
         ...
         <li ><a href="AddLife.aspx">إضافة موضوع</a></li>
                ...
                <li id="submenu-active"><a href="DeleteLifeType.aspx"> حذف تصنيف </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
