<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddTeacherMaterial.aspx.vb" Inherits="admin_AddTeacherMaterial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                <li id="submenu-active"><a href="AddTeacherMaterial.aspx"> إضافة ورقة عمل إلى المعلم</a></li>
                <li ><a href="DeleteTeacherMaterial.aspx">  حذف ورقة عمل من المعلم</a></li>
        ...
        <div id="content" class="box">
            <table width="99%">
                <tr>
                    <td colspan="2">
                        <p class=" msg info">
                            إضافة ورقة عمل إلى صفحة المعلم</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT Distinct ClassNameAr, ClassID FROM [Class]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td style="width: 111px">
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:Dar_AlsadiqConnectionString %>" 
                            SelectCommand="SELECT Distinct SubjectNameAr, SubjectID FROM [Subject]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td style="width: 111px">
