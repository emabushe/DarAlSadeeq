<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteActivityType.aspx.vb" Inherits="admin_DeleteActivityType" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <li ><a href="AddActivitySubject.aspx">إضافة موضوع</a></li>
                ...
                <li id="submenu-active"><a href="DeleteActivityType.aspx"> حذف تصنيف </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
