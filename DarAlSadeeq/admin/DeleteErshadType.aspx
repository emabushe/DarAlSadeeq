<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteErshadType.aspx.vb" Inherits="admin_DeleteErshadType" %>
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
              <li ><a href="AddErshadSubject.aspx">إضافة موضوع</a></li>
                ...
                <li id="submenu-active"><a href="DeleteErshadType.aspx"> حذف تصنيف </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
