<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddLifeType.aspx.vb" Inherits="admin_AddLifeType" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
                ...
                <li id="submenu-active"><a href="AddLifeType.aspx"> إضافة تصنيف </a></li>
