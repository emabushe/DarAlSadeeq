<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddGameClass.aspx.vb" Inherits="admin_AddGameClass" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
           ...
           <li <a href="AddGame.aspx">إضافة لعبة</a></li>
                ...
                <li id="submenu-active">><a href="AddGameClass.aspx"> إضافة تصنيف </a></li>
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <table width="99%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="تمت  عملية إضافة التصنيف بنجاح" 
