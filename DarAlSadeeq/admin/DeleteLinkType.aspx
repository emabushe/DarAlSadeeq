<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteLinkType.aspx.vb" Inherits="admin_DeleteLinkType" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
                ...
                <li id="submenu-active"><a href="DeleteLinkType.aspx">  حذف تصنيف</a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DrpDwnClassName" runat="server" 
                            DataSourceID="SqlDataSource1" DataTextField="LinkType" 
                            DataValueField="LinkTypeID">
                        </asp:DropDownList>
