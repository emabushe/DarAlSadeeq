<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteAds.aspx.vb" Inherits="admin_DeleteAds" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                      <li ><a href="AddAds.aspx">إضافة شريك</a></li>
                <li id="submenu-active"><a href="DeleteAds.aspx">حذف  شريك</a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [Advertisements]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    <td>
