<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteDemo.aspx.vb" Inherits="admin_DeleteDemo" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
          ...
          <li ><a href="AddDemo.aspx">إضافة ورقة عمل</a></li>
                <li id="submenu-active" ><a href="DeleteDemo.aspx">حذف ورقة عمل</a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
