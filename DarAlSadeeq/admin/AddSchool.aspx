<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddSchool.aspx.vb" Inherits="admin_AddSchool" %>
        ...
        <div id="content" class="box">
            <table width="99%">
                <tr>
                    <td colspan="2">
                        <p class=" msg info">
                            إضافة مدرسة إلى قائمة المدارس الصديقة</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtWebsite" runat="server" Width="50%"></asp:TextBox>
