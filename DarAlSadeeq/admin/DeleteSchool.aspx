<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteSchool.aspx.vb" Inherits="admin_DeleteSchool" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
            <li ><a href="AddSchool.aspx">إضافة مدرسة  </a></li>
                <li id="submenu-active"><a href="DeleteSchool.aspx">حذف مدرسة  </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <table width="99%">
                <tr>
                    <td colspan="2">
                         <p class=" msg info">
                            حذف مدرسة من قائمة المدارس الصديقة</p>
                    </td>
                </tr>
                <tr>
