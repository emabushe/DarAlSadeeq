<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddLife.aspx.vb" Inherits="admin_AddLife" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                <li id="submenu-active"><a href="AddLife.aspx">إضافة موضوع</a></li>
