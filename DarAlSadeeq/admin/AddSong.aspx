<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddSong.aspx.vb" Inherits="admin_AddSong" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                <li id="submenu-active"><a href="AddSong.aspx">إضافة أغنية أو قصة</a></li>
                <li ><a href="DeleteSong.aspx">حذف  أغنية أو قصة</a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
        ...
        <div id="content" class="box">
            <table width="99%">
                <tr>
                    <td colspan="2">
                        <p class=" msg info">
                            إضافة قصة أو أغنية</p>
                    </td>
                </tr>
                <tr>
                    <td style="width: 111px">
                        <p>
                            اسم&nbsp; الأغنية أو القصة</p>
                    </td>
                    <td>
