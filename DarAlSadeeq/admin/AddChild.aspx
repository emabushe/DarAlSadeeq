<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddChild.aspx.vb" Inherits="admin_AddChild" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                <li id="submenu-active"><a href="AddChild.aspx">إضافة موضوع</a></li>
                <li ><a href="DeleteChild.aspx">حذف  موضوع</a></li>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [Ershad]">
