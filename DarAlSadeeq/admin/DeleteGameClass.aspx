<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteGameClass.aspx.vb" Inherits="admin_DeleteGameClass" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <li ><a href="AddGame.aspx">إضافة لعبة</a></li>
                ...
                <li id="submenu-active"><a href="DeleteGameClass.aspx"> حذف تصنيف </a></li>
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <table width="99%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="تمت  عملية حذف التصنيف بنجاح" 
