<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteDemoSubject.aspx.vb" Inherits="admin_DeleteDemoSubject" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
                ...
                <li id="submenu-active"><a href="DeleteDemoSubject.aspx"> حذف مادة </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
