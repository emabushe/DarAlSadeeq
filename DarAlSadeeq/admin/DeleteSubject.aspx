<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteSubject.aspx.vb" Inherits="admin_DeleteSubject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <!-- /padding -->
            <ul class="box">
                <li ><a href="AddLearn.aspx">إضافة ورقة عمل</a></li>
                <li ><a href="DeleteLearn.aspx">حذف ورقة عمل</a></li>
                <li><a href="AddClass.aspx">إضافة صف</a></li>
                <li ><a href="DeleteClass.aspx">  حذف صف</a></li>
                <li><a href="AddSubject.aspx"> إضافة مادة </a></li>
                <li id="submenu-active"><a href="DeleteSubject.aspx"> حذف مادة </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
