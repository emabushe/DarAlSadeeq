<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="AddHandMakeType.aspx.vb" Inherits="admin_AddHandMakeType" %>
    ...
    <div id="cols" class="box">
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
                ...
                <li id="submenu-active"><a href="AddHandMakeType.aspx"> إضافة تصنيف </a></li>
                <li><a href="DeleteHandMakeType.aspx"> حذف تصنيف </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
