<%@ Page Title="" Language="VB" MasterPageFile="~/admin/MasterPage_admin.master" AutoEventWireup="false" CodeFile="DeleteHandMakeType.aspx.vb" Inherits="admin_DeleteHandMakeType" %>
        ...
        <div id="aside" class="box">
            ...
            <ul class="box">
              <li ><a href="AddErshadSubject.aspx">إضافة موضوع</a></li>
                ...
                <li ><a href="AddHandMakeType.aspx"> إضافة تصنيف </a></li>
                <li id="submenu-active"><a href="DeleteHandMakeType.aspx"> حذف تصنيف </a></li>
            </ul>
        </div>
        <!-- /aside -->
        <hr class="noscreen" />
