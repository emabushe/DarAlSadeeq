<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Guidance.aspx.vb" Inherits="ar_Guidance" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al Sadeeq :: Tips For Kids</title>
    <!-- Styles Start-->
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block7" onclick="nextFrame()">
                ...
                <div id="page2">
                    <div class="blocks-container">
                        <div class="block-main guidance no-margin" onclick="prevFrameNotSubjects();">
                            <span>Tips For Kids</span></div>
                        <h1>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Pic")%>'  Width="100" Height="100" />
                                    ...
                                    <tr><td style=" text-align:center "> <a href='<%# "GuidanceList.aspx?sid=" + Eval("ID").tostring%>' style="font-size: large"><%#Eval("Type")%></a> 
                                    </td>
                                    </tr>
                                    </table>
                                </div>
