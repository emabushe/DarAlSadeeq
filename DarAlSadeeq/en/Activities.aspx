<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Activities.aspx.vb" Inherits="ar_Activities" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Activities</title>
    <!-- Styles Start-->
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block6" onclick="nextFrame()">
                ...
                <div id="page2">
                    <div class="blocks-container">
                        <div class="block-main activities no-margin" onclick="prevFrameNotSubjects();">
                        ...
                        <h1>
                            ...
                            <ItemTemplate>
                                <div style="float: right; width: 180px;  text-align: center">
                                  <table width="180px"><tr><td align="center" style="padding-top:20px;"> 
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Pic")%>'  Width="100" Height="100" />
                                    </td>
                                    </tr>
                                    <tr><td style=" text-align:center "> <a href='<%# "Activity.aspx?sid=" + Eval("ID").tostring%>' style="font-size: large"><%#Eval("Type")%></a> 
                                    </td>
                                    </tr>
                                    </table>
                                </div>
                        ...
                        <div class="footerDiv">
                                    <ul>
                                        <li><a href="Partners.aspx" id="A5">Partners</a> * <a href="Schools.aspx" id="A6">Schools
                                        </a></li>
                                        <li style="padding-top: 10px"><a href="AboutUs.aspx" id="a7">About Us </a> * <a href="ContactUs.aspx"
                                            id="A8">Contact Us</a></li></ul>
                                </div>
                                <div class="smIcons">
                                    <a href="http://www.facebook.com/daralsadeeq" class="fb" target="_blank"></a><a href="http://www.youtube.com/daralsadeeq"
                                        class="youtube" target="_blank"></a>
