<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Partners.aspx.vb" Inherits="ar_Partners" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Partners</title>
    <!-- Styles Start-->
                ...
                <div id="page2">
                    <div class="blocks-container">
                        <div class="block-main generalTab no-margin" onclick="prevFrameNotSubjects();">
                            <span style="color: #79471D">Partners</span></div>
                        <h1>
                                                ...
                                                <table width="200px">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 5px; text-align: center">
                                                            <a href='<%#Eval("PartnerURL").tostring%>' style="font-size: large; font-family: Calibri;
