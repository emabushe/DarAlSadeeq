<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HandMake.aspx.vb" Inherits="ar_HandMake" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Artcraft</title>
    <!-- Styles Start-->
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block8" onclick="nextFrame()">
                        ...
                        <h1>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Pic")%>'  Width="100" Height="100" />
                                    ...
                                    <tr><td style=" text-align:center "> <a href='<%# "HandMakeList.aspx?sid=" + Eval("ID").tostring%>' style="font-size: large"><%#Eval("Type")%></a> 
                                    </td>
                                    </tr>
                                    </table>
                                </div>
