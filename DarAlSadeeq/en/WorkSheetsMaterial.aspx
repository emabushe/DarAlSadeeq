<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WorkSheetsMaterial.aspx.vb"
    Inherits="ar_WorkSheetsMaterial" %>
                                ...
                                <h1>
                                    ...
                                    <div id="materials" class="subjectsContainer materialsList" runat="server">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                <li><a href='<%# "view.aspx?mid=" + Eval("MaterialID").tostring%>' id="link1" runat="server">
                                                    <%#Eval("TitleEN")%></a>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
