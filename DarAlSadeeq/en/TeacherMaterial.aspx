<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TeacherMaterial.aspx.vb" Inherits="ar_TeacherMaterial" %>
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block4 no-margin" onclick="location.href='Teacher.aspx'">
                                ...
                                <h1>
                                    ...
                                    <div id="subjectsContainer" class="subjectsContainer material" runat="server">
                                        <table width="180px">
                                            <tr>
                                                <td align="center">
                                                    <asp:Image ID="ImgSubject" runat="server" onclick="viewMaterials()" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px; text-align: center">
                                                    <a id="aSubjectName" runat="server" style="font-size: large" onclick="viewMaterials()">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div id="materials" class="subjectsContainer materialsList" runat="server">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                <li><a href='<%# "view.aspx?mid=" + Eval("FileID").tostring%>' id="link1" runat="server">
                                                    <%#Eval("FileTitle")%></a>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
