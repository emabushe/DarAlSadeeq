<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ibooks.aspx.vb" Inherits="en_ibooks" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Interactive Books</title>
    <!-- Styles Start-->
                        ...
                        <ContentTemplate>
                            <div class="blocks-container">
                                <div class="block-main ibooks no-margin" onclick="prevFrameNotSubjects();">
                                    <span>Interactive Books</span></div>
                                <h1>
                                    <div id="subjectsContainer" class="subjectsContainer SongStories" style="display:block;">  
                                       <div><span>Interactive Books are under construction<br />    </span>
