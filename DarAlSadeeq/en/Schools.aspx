<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Schools.aspx.vb" Inherits="ar_Schools" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Schools</title>
    <!-- Styles Start-->
                ...
                <div id="page2">
                    <div class="blocks-container">
                        <div class="block-main generalTab no-margin" onclick="prevFrameNotSubjects();">
                            <span style="color: #79471D">Schools</span></div>
                        <h1>
                                                ...
                                                <table width="200px">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 5px; text-align: center">
                                                            <a href='<%#Eval("SchoolURL").tostring%>' style="font-size: large;
