<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LinkGamesList.aspx.vb" Inherits="ar_LinkGamesList" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Games</title>
    <!-- Styles Start-->
            ...
            <div id="everythingInside" class="everything-inside">
                ...
                <div id="page2">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="blocks-container">
                                <div class="block-main gamesBlock no-margin" onclick="prevFrameNotSubjects();">
                            <span>ألعاب</span></div>
                                <h1>
                                    ...
                                    <div id="subjectsContainer" class="subjectsContainer material" runat="server">
                                        <table width="180px">
                                            <tr>
                                                <td align="center">
                                                    <asp:Image ID="ImgSubject" runat="server" onclick="location.href='LinkGames.aspx" Width="85" Height="85" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                    <a id="aActivitytName" runat="server" style="font-size: large" onclick="viewMaterials()" href="LinkGames.aspx">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div id="materials" class="subjectsContainer materialsList" runat="server">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                               <li><a href='<%# Eval("GameURL").tostring%>' id="link1" runat="server" target="_blank">
                            <%# Eval("GameTitle")%></a>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
