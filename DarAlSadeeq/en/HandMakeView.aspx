<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HandMakeView.aspx.vb" Inherits="ar_HandMakeView" %>
                                ...
                                <h1>
                                      <div id="Div1" class="subjectsContainer material" runat="server">
                                        <table width="180px">
                                            <tr>
                                                <td align="center">
                                                    <asp:Image ID="ImgHandMake" runat="server" onclick="location.href='HandMake.aspx" Width="85" Height="85" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                    <a id="HandMakeType" runat="server" style="font-size: large"  href="HandMake.aspx">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
