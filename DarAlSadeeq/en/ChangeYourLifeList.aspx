<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ChangeYourLifeList.aspx.vb" Inherits="ar_ChangeYourLifeList" %>
                            ...
                            <h1>
                                    ...
                                    <table width="180px">
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                <a id="aChangeYourLifeName" runat="server" style="font-size: large" href="ChangeYourLife.aspx">
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div id="materials" class="subjectsContainer materialsList" runat="server">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <li><a href='<%# "ChangeYourLifeView.aspx?mid=" + Eval("ID").tostring%>' id="link1" runat="server">
                                                <%# Eval("Title")%></a>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
