<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SongStories.aspx.vb" Inherits="ar_SongsStories" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Songs & Stories</title>
    <!-- Styles Start-->
