<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GuidanceList.aspx.vb" Inherits="ar_GuidanceList" %>
                            ...
                            <h1>
                                    ...
                                    <table width="180px">
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                <a id="aGuidanceName" runat="server" style="font-size: large" href="Guidance.aspx">
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div id="materials" class="subjectsContainer materialsList" runat="server">
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <li><a href='<%# "GuidanceView.aspx?mid=" + Eval("ID").tostring%>' id="link1" runat="server">
                                                <%# Eval("ErshadSub")%></a>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
