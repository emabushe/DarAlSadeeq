<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ChangeYourLife.aspx.vb" Inherits="ar_ChangeYourLife" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: Change Your Life</title>
    <!-- Styles Start-->
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Dar_AlsadiqConnectionString %>"
        SelectCommand="SELECT * FROM [LifeType]"></asp:SqlDataSource>
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block9" onclick="nextFrame()">
                ...
                <div id="page2">
                    <div class="blocks-container">
                        <div class="block-main changeYourLife no-margin" onclick="prevFrameNotSubjects();">
                            <span>Change Your Life</span></div>
                        <h1>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Pic")%>'  Width="100" Height="100" />
                                    ...
                                    <tr><td style=" text-align:center "> <a href='<%# "ChangeYourLifeList.aspx?sid=" + Eval("ID").tostring%>' style="font-size: large"><%#Eval("Type")%></a> 
                                    </td>
                                    </tr>
                                    </table>
                                </div>
