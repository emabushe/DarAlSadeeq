...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Dar Al-Sadeeq :: About Us</title>
    <!-- Styles Start-->
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="blocks-container">
                                ...
                                <div class="footerDiv">
                                    <ul>
                                        <li><a href="Partners.aspx" id="A1">Partners</a> * <a href="Schools.aspx" id="A2">Schools
                                        </a></li>
                                        <li style="padding-top: 10px"><a href="AboutUs.aspx" id="a3">About Us </a> * <a href="ContactUs.aspx"
                                            id="A4">Contact Us</a></li></ul>
                                </div>
                                <div class="smIcons">
                                    <a href="http://www.facebook.com/daralsadeeq" class="fb" target="_blank"></a><a href="http://www.youtube.com/daralsadeeq"
                                        class="youtube" target="_blank"></a>
