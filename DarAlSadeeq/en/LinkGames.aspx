<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LinkGames.aspx.vb" Inherits="ar_LinkGames" %>
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        ...
                        <div class="block-main block5" onclick="nextFrame()">
                        ...
                        <h1>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Pic")%>'  Width="100" Height="100" />
                                    ...
                                    <tr><td style=" text-align:center "> <a href='<%# "LinkGamesList.aspx?sid=" + Eval("TypeID").tostring%>' style="font-size: large"><%#Eval("GameType")%></a> 
                                    </td>
                                    </tr>
                                    </table>
                                </div>
