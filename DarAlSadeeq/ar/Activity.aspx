<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Activity.aspx.vb" Inherits="ar_Activity" %>
                                ...
                                <h1>
                                    ...
                                    <div id="subjectsContainer" class="subjectsContainer material" runat="server">
                                        <table width="180px">
                                            <tr>
                                                <td align="center">
                                                    <asp:Image ID="ImgSubject" runat="server" onclick="location.href='Activities.aspx" Width="85" Height="85" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                    <a id="aActivitytName" runat="server" style="font-size: large" onclick="viewMaterials()" href="Activities.aspx">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div id="materials" class="subjectsContainer materialsList" runat="server">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                               <li><a href='<%# "ErshadView.aspx?mid=" + Eval("ID").tostring%>' id="link1" runat="server">
                            <%# Eval("ActivitySub")%></a>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
