<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ActivityView.aspx.vb" Inherits="ar_ActivityView" %>
...
<body>
    ...
    <div class="site-container">
        <div class="clouds-container">
            ...
            </div><div class="enlanguage">
                <ul>
                    <li><a href="toEn(window.location);">English</a></li>
                </ul>
            </div>
                                ...
                                <h1>
                                      <div id="Div1" class="subjectsContainer material" runat="server">
                                        <table width="180px">
                                            <tr>
                                                <td align="center">
                                                    <asp:Image ID="ImgActivity" runat="server" onclick="location.href='Activities.aspx" Width="85" Height="85" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                    <a id="ActivityType" runat="server" style="font-size: large" href="Activities.aspx">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div id="subjectsContainer" class="subjectsContainer material" runat="server">
                                        <asp:Label ID="lblActivityTitle" runat="server"></asp:Label>
                                    </div>
