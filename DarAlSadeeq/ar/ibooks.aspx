<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ibooks.aspx.vb" Inherits="ar_ibooks" %>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>دار الصديق :: الكتب الإلكترونية</title>
    <!-- Styles Start-->
            ...
            <div id="everythingInside" class="everything-inside">
                <div id="page1" style="display: none;">
                    <div class="blocks-container">
                        <div class="block-main" onclick="nextFrame()">
                ...
                <div id="page2">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="blocks-container">
                                <div class="block-main ibooks no-margin" onclick="prevFrameNotSubjects();">
                                    <span>الكتب الإلكترونية</span></div>
                                <h1>
                                    <div id="subjectsContainer" class="subjectsContainer SongStories" style="display:block;">
                                       <div><span>قسم الكتب الإلكترونية تحت الإنشاء<br />كتب تفاعلية مليئة بالمعرفة والمتعة قريباً</span>
