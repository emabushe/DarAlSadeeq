<%@ Page Title="" Language="C#" MasterPageFile="~/ar/MasterPage.master" AutoEventWireup="true" CodeBehind="ChangeYourLife.aspx.cs" Inherits="DarAlSadeeq.ar.ChangeYourLife" %>
                ...
                <ItemTemplate>
                    <div style="float: right; width: 180px; text-align: center">
                        <table width="180px">
                            ...
                            <tr>
                                <td style="text-align: center"><a href='<%# "ChangeYourLifeList.aspx?sid=" + Eval("ID")%>' style="font-size: large"><%#Eval("Type")%></a>
                                </td>
                            </tr>
                        </table>
                    </div>
