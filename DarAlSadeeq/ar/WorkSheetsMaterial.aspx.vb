Partial Class ar_WorkSheetsMaterial
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If subjectID = 86 Or subjectID = 87 Or subjectID = 88 Or subjectID = 89 Or subjectID = 90 Or subjectID = 91 Or subjectID = 92 Or subjectID = 93 Or subjectID = 94 Or subjectID = 95 Or subjectID = 96 Or subjectID = 97 Or subjectID = 98 Or subjectID = 99 Or subjectID = 100 Or subjectID = 101 Or subjectID = 102 Or subjectID = 103 Or subjectID = 107 Then
                Dim DT2 As Data.DataTable = Worksheets.ListGames(subjectID)
                Session("IsGame") = "Yes"
                If DT2.Rows.Count <> 0 Then
                    Me.Title = "دار الصديق :: " & DT2.Rows(0).Item("ClassNameEN") & " - " & DT2.Rows(0).Item("SubjectNameEN")
